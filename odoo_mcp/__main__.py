"""Entry point for the odoo-mcp package.
...
def main(argv: Optional[list[str]] = None) -> int:
  ...
  ODOO_API_KEY       API key for stdio transport.
                     JSON/2: plain key.  XML-RPC: 'username:api_key'.
                     HTTP transport: omit — clients supply a Bearer token.
...
For more information, visit: https://github.com/ivnvxd/odoo-mcp""",
    )
