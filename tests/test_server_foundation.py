...
from odoo_mcp.server import SERVER_VERSION, OdooMCPServer
...
class TestServerFoundation:
    ...
    def server_with_mock_connection(self, valid_config):
        ...
        with patch("odoo_mcp.server.OdooConnection") as mock_conn_class:
    ...
    def test_server_initialization_with_env_config(self, monkeypatch, tmp_path):
        ...
        from odoo_mcp.config import reset_config
    ...
    async def test_run_stdio_success(self, server_with_mock_connection):
        ...
        # Mock register_resources
        with patch("odoo_mcp.server.register_resources") as mock_register:
            mock_handler = Mock()
...
class TestServerIntegration:
    ...
    def test_server_with_env_file(self, tmp_path, monkeypatch):
        ...
        from odoo_mcp.config import load_config, reset_config
...
class TestMainEntry:
    ...
    def test_main_with_valid_config(self, monkeypatch):
        ...
        with patch("odoo_mcp.__main__.OdooMCPServer") as mock_server_class:
            mock_server = Mock()
