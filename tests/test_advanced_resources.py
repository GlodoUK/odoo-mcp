...
from odoo_mcp.resources import OdooResourceHandler
...
class TestBrowseResource:
    ...
    @pytest.mark.asyncio
    async def test_browse_multiple_records(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_browse_with_missing_records(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_browse_invalid_ids(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_browse_empty_ids(self, resource_handler):
...
class TestCountResource:
    ...
    @pytest.mark.asyncio
    async def test_count_all_records(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_count_complex_domain(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_count_zero_results(self, resource_handler, mock_connection):
...
class TestFieldsResource:
    ...
    @pytest.mark.asyncio
    async def test_fields_basic(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_fields_with_selection(self, resource_handler, mock_connection):
    ...
    @pytest.mark.asyncio
    async def test_fields_with_numeric(self, resource_handler, mock_connection):
...
class TestAdvancedResourceIntegration:
    ...
    async def test_browse_real_records(self, real_config, real_connection):
        ...
        handler = OdooResourceHandler(app, real_connection, real_config)
