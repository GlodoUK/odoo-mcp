...
from odoo_mcp.tools import OdooToolHandler, register_tools
...
class TestOdooToolHandler:
    ...
    @pytest.fixture
    def handler(self, mock_app, mock_connection, valid_config):
        """Create an OdooToolHandler instance."""
        return OdooToolHandler(mock_app, mock_connection, valid_config)
    ...
    @pytest.mark.asyncio
    async def test_search_records_success(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_search_records_connection_error(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_search_records_with_domain_operators(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_search_records_with_string_domain(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_search_records_with_string_fields(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_search_records_with_complex_domain(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_get_record_success(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_get_record_not_found(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_get_record_connection_error(self, handler, mock_connection, mock_app):
    ...
    @pytest.mark.asyncio
    async def test_list_models_success(self, handler, mock_connection, mock_app):
        """Test successful list_models operation."""
        # Setup mocks for search_read — the new implementation queries ir.model directly
    ...
    @pytest.mark.asyncio
    async def test_list_models_error(self, handler, mock_connection, mock_app):
        """Test list_models with error."""
        # Setup mocks
        mock_connection.search_read.side_effect = Exception("API error")
    ...
    async def test_search_records_with_defaults(
        self, handler, mock_connection, mock_app, valid_config
    ):
...
class TestRegisterTools:
    ...
    def test_register_tools_success(self):
        ...
        # Register tools
        handler = register_tools(mock_app, mock_connection, config)
