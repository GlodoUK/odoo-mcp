...
from odoo_mcp.tools import OdooToolHandler
...
class TestErrorSanitizationIntegration:
    ...
    def tool_handler(self):
        ...
        return OdooToolHandler(app, connection, config)
    ...
    def resource_handler(self):
        ...
        return OdooResourceHandler(app, connection, config)
    ...
    async def test_resource_error_sanitization(self, resource_handler):
        ...
        from odoo_mcp.error_handling import NotFoundError
    ...
    def test_complex_error_chain_sanitization(self):
        ...
        from odoo_mcp.error_sanitizer import ErrorSanitizer
